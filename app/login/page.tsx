      ...
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors font-medium text-gray-700 dark:text-gray-300"
          >
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 items-center justify-between">
              <Link
                href="/register"
                className="w-full sm:w-auto flex justify-center py-3 px-6 border border-primary rounded-lg text-primary hover:bg-primary hover:text-white transition-colors font-medium min-h-[48px] items-center"
              >
                Sign Up
              </Link>
              <Link

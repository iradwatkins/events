            ...
            <div className="p-6">
              ...
              <div className="flex gap-4 justify-center items-center">
                ...
                <svg className="h-8" viewBox="0 0 44 44" fill="none">
                  ...
                  <path d="M29.5 20.5C29.5 20.9 29.3 21.3 29 21.5L26.2 24.3C26 24.5 25.7 24.6 25.4 24.6C25.1 24.6 24.8 24.5 24.6 24.3C24.2 23.9 24.2 23.3 24.6 22.9L25.7 21.8H18.5C17.9 21.8 17.5 21.4 17.5 20.8C17.5 20.2 17.9 19.8 18.5 19.8H25.7L24.6 18.7C24.2 18.3 24.2 17.7 24.6 17.3C25 16.9 25.6 16.9 26 17.3L28.8 20.1C29.2 20.3 29.4 20.6 29.5 20.5ZM33 11H11C9.3 11 8 12.3 8 14V30C8 31.7 9.3 33 11 33H33C34.7 33 36 31.7 36 30V14C36 12.3 34.7 11 33 11Z" fill="white"/>
                </svg>

                {/* Cash App Logo */}
                <svg className="h-8" viewBox="0 0 120 120" fill="none">
                  <rect width="120" height="120" rx="24" fill="#00D632"/>
                  <path d="M84.5 42.5C84.5 41.1 83.4 40 82 40C80.6 40 79.5 41.1 79.5 42.5C79.5 46.4 77.1 49.8 73.5 51.3C72.2 51.9 71.7 53.5 72.3 54.8C72.7 55.7 73.6 56.2 74.5 56.2C74.8 56.2 75.2 56.1 75.5 56C81.1 53.6 84.5 48.5 84.5 42.5ZM67.2 44.8C66.7 42.3 64.5 40.5 62 40.5H53.5V36.5C53.5 35.1 52.4 34 51 34C49.6 34 48.5 35.1 48.5 36.5V40.5H45C43.6 40.5 42.5 41.6 42.5 43C42.5 44.4 43.6 45.5 45 45.5H48.5V65.5H45C43.6 65.5 42.5 66.6 42.5 68C42.5 69.4 43.6 70.5 45 70.5H48.5V74.5C48.5 75.9 49.6 77 51 77C52.4 77 53.5 75.9 53.5 74.5V70.5H62.5C65 70.5 67.2 68.7 67.7 66.2C68 63.7 66.7 61.5 64.5 60.5C66.7 59.5 68 57.3 67.7 54.8C67.2 52.3 65 50.5 62.5 50.5H53.5V45.5H62C62.3 45.5 62.5 45.7 62.5 46V47C62.5 48.4 63.6 49.5 65 49.5C66.4 49.5 67.5 48.4 67.5 47V46C67.5 45.5 67.4 45.1 67.2 44.8ZM62.5 55.5C62.8 55.5 63 55.7 63 56V57C63 57.3 62.8 57.5 62.5 57.5H53.5V55.5H62.5ZM53.5 65.5V63.5H62.5C62.8 63.5 63 63.7 63 64V65C63 65.3 62.8 65.5 62.5 65.5H53.5Z" fill="white"/>
                </svg>
              </div>
            </div>
          </div>

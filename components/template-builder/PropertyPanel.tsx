  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mt-1.5">Number of seats around this table (1-20)</p>
      </div>
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all"
        />
      </div>
      ...
      <div>
        <label className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
          <MoveVertical className="w-4 h-4 text-red-600" />
          Height
        </label>
        <div className="flex items-center gap-2">
          <button
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-all"
        />
      </div>

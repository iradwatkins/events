...
## 🎯 YOU ARE WORKING ON: **events-stepperslife**

**Project Root:** `/root/websites/events-stepperslife`
**Git Repo:** `https://github.com/iradwatkins/event.stepperslife.com.git`
**Port:** `3004`
**Database:** `events_stepperslife_db` on port `DB_3004`
...
1. **NEVER read files outside `/root/websites/events-stepperslife`**
2. **NEVER write files outside `/root/websites/events-stepperslife`**
...
Validate that the file path starts with `/root/websites/events-stepperslife`
...
I am currently locked to events-stepperslife to prevent code contamination.
...
```
✅ CORRECT: Serena, activate project: /root/websites/events-stepperslife
...
- ✅ Am I in /root/websites/events-stepperslife?
- ✅ Is this file within events-stepperslife?
- ✅ Am I using the events-stepperslife database?
- ✅ Am I committing to the events-stepperslife repo?
...
- ✓ I will ONLY work on events-stepperslife in this session

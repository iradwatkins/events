        ...
        <div className="bg-yellow-50 border-b border-yellow-200 px-4 py-3">
          <div className="container mx-auto flex items-center gap-3 text-sm">
            ...
            <p className="text-yellow-900">
              ...
              <code className="bg-yellow-100 px-2 py-0.5 rounded text-xs">npx convex dev</code> to
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <h3 className="text-sm font-semibold text-gray-900 mb-3">How Magic Link Works</h3>
